...
wget -O /usr/local/bin/ws-dropbear https://$hosting/Autoscript-by-azi-main/Insshws/dropbear-ws.py.txt
wget -O /usr/local/bin/ws-stunnel https://$hosting/Autoscript-by-azi-main/Insshws/ws-stunnel.txt
...
wget -O /etc/systemd/system/ws-dropbear.service https://$hosting/Autoscript-by-azi-main/Insshws/service-wsdropbear.txt && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://$hosting/Autoscript-by-azi-main/Insshws/ws-stunnel.service.txt && chmod +x /etc/systemd/system/ws-stunnel.service
